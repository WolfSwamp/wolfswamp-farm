...
contract SwampWolfToken is BEP20  {
    ...
    /**
     * @dev Self destroy `amount` tokens decreasing the total supply.
     *
     * Requirements
     *
     ...
     * Must only be called by the current admin.
     */
    function updateLpAddress(address lpAddress_) public onlyAdmin {
        _lpAddress = lpAddress_;
    }

    /**
     * @dev Returns the address of the current lpAddress.
     *
     */
    ...
    /**
    * @dev Include or exclude trading pair for burn after swap function.
    *
    * Requirements
    *
    * Must only be called by MasterChef through the functions addPool() or setPool().
    */
