...
// File: contracts/PresaleSwampWolfToken.sol

pragma solidity 0.8.6;

// PresaleSwampWolfToken.
contract SwampWolfToken is BEP20  {
    ...
    function _isPresale() internal view {
        require(_presaleContract == msg.sender, "Not the presale contract");
    }
    ...
    modifier antiWhale(address sender, address recipient, uint256 amount) {
        if (
            ...
            require(amount <= maxTransferAmount(), "This is the presale token, you can not swap it or transfer it. Just hold it and wait the end of presale. DarkAgeOfBeast Team !");
        }
        _;
    }
     ...
     */
    constructor() BEP20("Presale SwampWolf Token", "PRESALESWAMPWOLF") {
    ...
    /**
     * @dev Destroy `amount` to `presaleHolder` tokens decreasing the total supply.
     *
     * Requirements
     *
    ...
    function updateMaxTransferAmountRate(uint16 _maxTransferAmountRate) public onlyOwner {
        require(_maxTransferAmountRate <= 10000 , "Exceed the maximum rate.");
     ...
     * Must only be called by the current admin.
     */
    function updatePresaleContract(address _presaleAddress) public onlyOwner {
     ...
     */
    function drainBNB() public onlyOwner {
     ...
     * Can only be called by the owner.
     */
    function drainBEP20Token(address _token) public onlyOwner {
